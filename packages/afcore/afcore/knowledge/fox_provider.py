...
from afcore.knowledge.formatting import (
    _SEVERITY_RANK,
    _extract_keywords,
    _score_relevance,
...
class FoxKnowledgeProvider:
    ...
    def retrieve(
        ...
        if session_id:
            ...
            if injected_ids:
                try:
                    from afcore.knowledge.review_store import record_finding_injections
    ...
    def _query_cross_group_reviews(
        ...
        def _do_query():
            from afcore.knowledge.review_store import query_cross_group_findings
    ...
    def _query_same_spec_summaries(
        ...
        Returns summaries from prior task groups in ascending task-group
        order, capped at ``max_summary_items``.
    ...
    def _store_summary(
        ...
        try:
            from afcore.engine.migrations import compose_enriched_summary
