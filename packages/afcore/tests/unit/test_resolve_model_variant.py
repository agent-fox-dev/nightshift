...
from afcore.core.config import AgentFoxConfig, ArchetypesConfig, PerArchetypeConfig
...
class TestResolveModelVariantLayer1:
    ...
    def test_mode_level_model_variant_takes_precedence(self) -> None:
        ...
        from afcore.engine.sdk_params import resolve_model_variant
...
class TestResolveModelVariantLayer3:
    ...
    def test_layer3_returns_default_model_variant_from_registry(self) -> None:
        ...
        from afcore.archetypes import ArchetypeEntry
        from afcore.engine.sdk_params import resolve_model_variant
        ...
        with patch("afcore.engine.sdk_params.get_archetype", return_value=mock_entry):
            result = resolve_model_variant(config, "coder", mode="code")
            assert result == "extended"
    ...
    def test_layer3_with_mode_resolved_variant(self) -> None:
        ...
        from afcore.archetypes import ArchetypeEntry, ModeConfig
        from afcore.engine.sdk_params import resolve_model_variant
