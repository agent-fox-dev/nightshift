"""End-to-end smoke tests for afcore.io unified terminal IO.
...
class TestSmoke1AgentMode:
    ...
    def test_agent_mode_json_output(self) -> None:
        ...
        from afcore.io import AgentFoxGroup, common_options, emit_ok
        ...
        with patch("afcore.core.logging.setup_logging"):
...
class TestCallChainPropagation:
    ...
    def test_emit_error_matches_error_envelope(self) -> None:
        ...
        from afcore.io import emit_error, error_envelope
...
class TestStubAudit:
    """12.4: Verify no stub markers remain in afcore/io/ files."""
    ...
    def test_all_public_symbols_fully_implemented(self) -> None:
        ...
        for sym_name in afcore.io.__all__:
            sym = getattr(afcore.io, sym_name)
