...
class TestTriageUsesMaintainerHunt:
    ...
    async def test_resolve_model_tier_called_with_maintainer_hunt(self) -> None:
        ...
        with (
            patch("afcore.nightshift.triage.resolve_model_tier") as mock_tier,
            patch("afcore.nightshift.cost_helpers.nightshift_ai_call") as mock_ai,
        ):
    ...
    async def test_resolve_security_config_called_with_maintainer_hunt(self) -> None:
        ...
        with (
            patch("afcore.nightshift.triage.resolve_security_config") as mock_sec,
            patch("afcore.nightshift.triage.resolve_model_tier", return_value="STANDARD"),
            patch("afcore.nightshift.cost_helpers.nightshift_ai_call") as mock_ai,
        ):
