...
import afcore.core.config as config_mod
from afaudit.events import AuditEventType
from afcore.core.config import AgentFoxConfig, OrchestratorConfig, load_config
...
class TestConfigGenMetadata:
    ...
    def test_promoted_defaults_overrides_no_quality_gate(self) -> None:
        ...
        """
        from afcore.core.config_gen import _PROMOTED_DEFAULTS_OVERRIDES
    ...
    def test_schema_deprecated_fields_gone(self) -> None:
        ...
        try:
            from afcore.core.config_gen import _SCHEMA_DEPRECATED_FIELDS
