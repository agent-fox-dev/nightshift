...
from afcore.knowledge.review_store import VALID_SEVERITIES, ReviewFinding
from afcore.session.review_parser import _unwrap_items, parse_review_findings
...
class TestCaseNormalizationPreservesValues:
    ...
    def test_normalize_keys_preserves_values(self, items: list[int]) -> None:
        ...
        from afcore.session.review_parser import _normalize_keys
