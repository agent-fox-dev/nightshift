...
def _pipeline_context_manager(
    ...
    *,
    ...
    stack.enter_context(patch("afcore.workspace.harvest.harvest", new_callable=AsyncMock, return_value=harvest_files))
    stack.enter_context(patch("afcore.workspace.harvest.post_harvest_integrate", new_callable=AsyncMock))
    return stack
