...
class TestGotchaExtractionRemoved:
    ...
    def test_gotcha_extraction_removed(self) -> None:
        ...
        with pytest.raises((ImportError, ModuleNotFoundError)):
            importlib.import_module("afcore.knowledge.gotcha_extraction")
...
class TestGotchaStoreRemoved:
    ...
    def test_gotcha_store_removed(self) -> None:
        ...
        with pytest.raises((ImportError, ModuleNotFoundError)):
            importlib.import_module("afcore.knowledge.gotcha_store")
...
class TestErrataStoreRemoved:
    ...
    def test_errata_store_removed(self) -> None:
        ...
        with pytest.raises((ImportError, ModuleNotFoundError)):
            importlib.import_module("afcore.knowledge.errata_store")
...
class TestBlockingHistoryRemoved:
    ...
    def test_blocking_history_removed(self) -> None:
        ...
        with pytest.raises((ImportError, ModuleNotFoundError)):
            importlib.import_module("afcore.knowledge.blocking_history")
...
class TestNoDeadImports:
    ...
    def test_no_dead_imports(self) -> None:
        ...
        project_root = Path(__file__).parent.parent / "afcore"
        violations: list[str] = []
        ...
        for py_file in project_root.rglob("*.py"):
            ...
            for module in removed_modules:
                ...
                if f"import {module}" in content or f"from afcore.knowledge.{module}" in content:
