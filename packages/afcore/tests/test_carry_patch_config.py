...
class TestHubConfigDefaults:
    ...
    def test_afcore_config_hub_field_is_hub_config_instance(self) -> None:
    ...
    def test_afcore_config_hub_endpoint_url_defaults_to_empty_string(self) -> None:
...
class TestCarryPatchConfigDefaults:
    ...
    def test_afcore_config_carry_patch_field_is_carry_patch_config_instance(self) -> None:
    ...
    def test_carry_patch_all_defaults_via_afcore_config(self) -> None:
...
class TestExtraFieldsIgnored:
    ...
    def test_afcore_config_ignores_unknown_hub_keys_via_toml(self) -> None:
...
class TestAgentFoxConfigBackwardCompatibility:
    ...
    def test_afcore_config_without_hub_section_loads_defaults(self) -> None:
    ...
    def test_afcore_config_hub_field_present_as_attribute(self) -> None:
    ...
    def test_afcore_config_carry_patch_field_present_as_attribute(self) -> None:
